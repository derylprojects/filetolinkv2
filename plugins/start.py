        ...
        reply_markup = InlineKeyboardMarkup(
            ...
            [
                ...
                [
                    ...
                    InlineKeyboardButton("👋 Tentang Developer", callback_data = "about"),
...
@Bot.on_message(filters.private & filters.command('pengguna'))
...
async def send_text(client: Bot, message: Message):
    ...
    if message.reply_to_message:
        ...
        pls_wait = await message.reply("<i>Mengirim.. mungkin membutuhkan waktu yang lama</i>")
